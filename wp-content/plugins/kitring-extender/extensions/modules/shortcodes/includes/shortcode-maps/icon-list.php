...
$param = array(
	'name'				=> esc_attr__( 'Icon List', 'sobari_sc' ),
	'base'				=> 'icon_list',
	'category'	=> array( 'Content' ),
	'description'		=> esc_attr__( 'Display icon list in styles', 'sobari_sc' ),
	'icon'				=> DAHZEXTENDER_SHORTCODE_URI . "assets/images/icon/df_element-icon-list-icon.svg",
	'params'			=> array(),
	'dahz_animated_on'	=> true
);
$param['params'][] = array(
	'type'			=> 'radio_image',
	'heading'		=> esc_attr__( 'Icon List Style', 'sobari_sc' ),
	'param_name'	=> 'style',
	'description'	=> esc_attr__( 'Icon List Style.', 'sobari_sc' ),
	'std'			=> 'style-1',
	'value'			=> array(
		'style-1'	=> DAHZEXTENDER_SHORTCODE_URI . "assets/images/shortcode/df_icon-list-style-1.svg",
		'style-2'	=> DAHZEXTENDER_SHORTCODE_URI . "assets/images/shortcode/df_icon-list-style-2.svg",
		'style-3'	=> DAHZEXTENDER_SHORTCODE_URI . "assets/images/shortcode/df_icon-list-style-3.svg"
	)
);
...
$param['params'][] = array(
	'type'			=> 'dropdown',
	'heading'		=> esc_attr__( 'Icon List Alignment', 'sobari_sc' ),
...
$param['params'][] = array(
	'type'			=> 'checkbox',
	'heading'		=> esc_attr__( 'Inline icon with title', 'sobari_sc' ),
	'param_name'	=> 'enable_inline_icon_title',
