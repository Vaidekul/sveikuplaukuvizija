...
$content_padding = $is_boxed && $enable_featured_image ? 'uk-padding uk-padding-remove-top' : '';

$meta_padding = $is_boxed && $enable_featured_image ? 'uk-padding uk-padding-remove-bottom' : '';
...
$wrapper_attributes = array(
	'class' 			=> array(
		...
		$box_shadow,
		$hover_box_shadow,
		$is_boxed && ! $enable_featured_image ? 'uk-padding' : '',
		'entry-wrapper'
	),
	'style' 			=> array(),
...
<li <?php post_class( 'de-sc-post-slider__item uk-margin-remove-bottom ' . $item_class );?>>
	<div <?php
		...
		<div class="<?php echo $meta_padding;?>">
			<?php
