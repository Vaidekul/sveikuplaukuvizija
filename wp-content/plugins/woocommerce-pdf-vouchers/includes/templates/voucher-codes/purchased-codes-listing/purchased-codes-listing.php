...
<a href="<?php echo esc_url($generatepdfurl); ?>" id="woo-vou-pdf-btn" class="woo-vou-btn-front woo-vou-grnpdf-btn" title="<?php echo __('Generate PDF','woovoucher'); ?>"><?php echo esc_html__( 'Generate PDF', 'woovoucher' ); ?></a>
	...
	if( empty( $result_arr ) ) {
		...
		?>
			<tr class="woo-vou-purchased-codes-row-body">
				...
				?>
				<td class="woo-vou-purchased-code-list-codes code column-code has-row-actions column-primary"  data-colname="Voucher Code"><?php 	echo $value['code']; do_action('woo_vou_after_purchased_voucher_code_column', $value['ID'],$value['code']);?> <button type="button" class="toggle-row"><span class="screen-reader-text"><?php esc_html_e( 'Show more details', 'woovoucher' ); ?></span></button></td>
				<?php 
