...
# EXTRA TAB
	...
	if( $custom_responsive_translate_el_col == 'yes' ) {
		$col_translate_responsive = sprintf(
			'
			<style>
				@media only screen and ( max-width: 414px ) {
					.de-column[data-dahz-id="%1$s"] {
						left: %2$s;
						margin-top: %3$s;
					}
				}
			...
			',
			$dahz_id,
			!empty( $col_translate_x_xsmall ) ? esc_html( $col_translate_x_xsmall ) . '!important' : 'inherit',
			!empty( $col_translate_y_xsmall ) ? esc_html( $col_translate_y_xsmall ) . '!important' : 'inherit',
			!empty( $col_translate_x_small_col ) ? esc_html( $col_translate_x_small_col ) . '!important' : 'inherit',
			!empty( $col_translate_y_small_col ) ? esc_html( $col_translate_y_small_col ) . '!important' : 'inherit',
			!empty( $col_translate_x_med_col ) ? esc_html( $col_translate_x_med_col ) . '!important' : 'inherit',
			!empty( $col_translate_y_med_col ) ? esc_html( $col_translate_y_med_col ) . '!important' : 'inherit'
			
		);
		echo( $col_translate_responsive );
	}
