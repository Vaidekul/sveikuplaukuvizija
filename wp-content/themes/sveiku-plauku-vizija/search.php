...
dahz_framework_get_template_part( 'global/global-wrapper', 'open' );
	...
	if ( have_posts() ) :
		...
		$loop_posts = dahz_framework_get_post_columns( dahz_framework_get_option( 'blog_archive_column', 1 ), dahz_framework_get_option( 'blog_archive_order', 1 ) );
		
		foreach ( $loop_posts as $loop_post ) : ?>
		
			<div class="search-container123">
