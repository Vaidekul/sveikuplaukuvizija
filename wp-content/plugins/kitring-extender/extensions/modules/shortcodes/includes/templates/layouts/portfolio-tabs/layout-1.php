...
foreach( $post_query as $post ){
	...
	$categories_html = '';
	// dahz_framework_debug($list_category);
	...
	<li class="de-sc-portfolio-tabs__item <?php foreach ($list_category as $key => $value) { echo esc_attr( $value->slug ) . ' '; } ?>">
		<div <?php
			...
			<?php endif; ?>
			<div class="de-sc-portfolio-tabs__content uk-margin-large-top uk-padding uk-position-bottom uk-flex uk-flex-between uk-flex-middle uk-padding">
                ...
                <div class="de-sc-portfolio-tabs__arrow uk-transition-slide-left-small">
                    <i style="color: <?php echo esc_attr( $hover_text_color ) ?>" data-uk-icon="icon:arrow-right;ratio:3"></i>
                </div>
			</div>
		</div>
	</li>
