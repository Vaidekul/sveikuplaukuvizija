...
foreach( $post_query as $post ){
	...
	<li class="de-sc-portfolio-tabs__item <?php foreach ($list_category as $key => $value) { echo esc_attr( $value->slug ) . ' '; } ?>">
		<div <?php
			...
			<?php endif;?>
			<div style="background: <?php echo esc_attr( $overlay_color ) ?>" class="de-sc-portfolio-tabs__content uk-position-bottom uk-padding uk-padding uk-overlay uk-transition-fade">
				<?php
